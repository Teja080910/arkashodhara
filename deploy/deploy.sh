...
echo "    sudo cp deploy/nginx.conf /etc/nginx/sites-available/arkasodhara.tech"
echo "    sudo ln -sf /etc/nginx/sites-available/arkasodhara.tech /etc/nginx/sites-enabled/"
echo "    sudo nginx -t && sudo systemctl reload nginx"
echo "    sudo certbot --nginx -d arkasodhara.tech -d www.arkasodhara.tech"
